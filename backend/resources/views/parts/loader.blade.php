<div id="loader" class="hidden fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-50 overflow-hidden bg-gray-700 opacity-75 flex flex-col items-center justify-center">
    ...
    <h2 class="text-center text-white text-xl font-semibold">Wczytywanie danych...</h2>
    <p class="w-1/3 text-center text-white">To chwilę może potrwać. Zaciągamy z PUBG Twoje osiągnięcia!</p>
</div>
