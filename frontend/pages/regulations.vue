...
<template>
  <div class="container page_header">
    <h1 class="page_header--title">{{ t('regulations') }}</h1>
<!--    <div class="page_header&#45;&#45;subtitle">Phasellus tempus. Etiam imperdiet imperdiet orci. Quisque id mi. Mauris turpis nunc, blandit et, volutpat molestie, porta ut, ligula. Vestibulum rutrum, mi nec elementum vehicula, eros quam gravida nisl, id fringilla neque ante vel mi. In hac habitasse platea dictumst. Suspendisse nisl elit, rhoncus eget, elementum ac, condimentum eget, diam. Sed in libero ut nibh placerat accumsan. In turpis. Quisque malesuada placerat nisl</div>-->
  </div>

  <div class="container">
    <h2 class="page_secondHeader">Dokumenty</h2>
    <div class="beam"></div>
    <div class="blog_documentList">
      <div class="blog_documentItem">
        <div class="icon">
        ...
        <div class="document-info">Regulamin Platformy BL Paczka_v7</div>
        <div class="document-info document-info--hideMobile">Format: PDF</div>
        <div class="document-info document-info--hideMobile">Rozmiar: 333 KB</div>
        <div class="download-button">
          <a href="/files/Regulamin_Platformy_BL_Paczka_v7.pdf" class="buttonSecondary" download>Pobierz plik</a>
        </div>
      </div>
    </div>
  </div>
